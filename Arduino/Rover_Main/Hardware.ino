...
volatile byte         runningMode = ROV_SPI_PI;      //can be used to denote local Arduino control (1) or Pi control (0), or other uses in user code
...
// ***************************************************
// Dependanct Classes and Structure
// ***************************************************
...
int ResolveMotorSpeed(int inputMotorSpeed = 0)
{
	if (inputMotorSpeed > MOTOR_MAX)
		inputMotorSpeed = MOTOR_MAX;
	if (inputMotorSpeed < -MOTOR_MAX)
		inputMotorSpeed = -MOTOR_MAX;
	return inputMotorSpeed;
}

void motors(int LeftMotorSpeed, int RightMotorSpeed){//Ver. 1.0, Dustin Soodak
  LeftMotor= ResolveMotorSpeed(LeftMotorSpeed);
  RightMotor= ResolveMotorSpeed(RightMotorSpeed);
